...
<body <?php body_class(); ?> id="top">
	...
	<a class="skip-link screen-reader-text" href="#main-content-sticky">
		<?php _e('Skip to content', 'newspaperss-tr'); ?>
	</a>

	<div id="wrapper" class="grid-container no-padding small-full <?php if (true == get_theme_mod('newspaperss_body_fullwidth', true)) : ?> full <?php endif; ?> z-depth-2">
		<!-- Site HEADER -->
								...
								<ul class="horizontal menu  desktop-menu dropdown">
									<li id="add-menu" class="menu-item">
										<a href=" <?php echo esc_url(admin_url('nav-menus.php')); ?>  ">
											<?php echo esc_html__('Add a Primary Menu', 'newspaperss-tr'); ?>
										</a>
									</li>
								</ul>
							<?php endif; ?>
