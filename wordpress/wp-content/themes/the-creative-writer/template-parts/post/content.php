...
<?php } ?>
	...
	<div class="entry-content">
		...
		if(!is_single() && !is_page())  the_excerpt();
			...
			__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'the-creative-writer' ),
			get_the_title()
		) );


		wp_link_pages( array(
			'before'      => '<div class="page-links">' . __( 'Pages:', 'the-creative-writer' ),
			'after'       => '</div>',
		...
		if ( !is_single() && !is_page() ) {
			...
			?>
			<a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" class="button button-readmore"><?php echo esc_html__( 'Read more', 'the-creative-writer' ); ?></a>
			<?php
		}
