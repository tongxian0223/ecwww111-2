            ...
            <div class="kt-dashboard-col kt-dashbord-col-70 kd-dashboard-content-wrapper">
                ...
                <div class="kt-dashboard-box pro-features">
                    ...
                    <ul class="kt-dashboard-ul">
                        ...
                        <li class="kt-dashboard-li kt-dashbord-col-100"><a href="<?php echo esc_url( self::$document_url . 'font-manager/' ); ?>"><?php echo esc_html__( 'Fonts Manager', 'kata' ); ?><span class="kt-pro-learn-more"><?php echo esc_html__( 'Learn More', 'kata' ); ?><i class="dashicons dashicons-arrow-right-alt2"></i></span></a></li>
                    ...
                    <div class="kt-dashboard-box kt-dashboard-has-pad">
                        ...
                        <div class="kt-dashboard-sidebar-widget">
                            <p>
                                <?php
                                // phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment
                                echo wp_sprintf( __( 'Feel free to join the Kata community and ask us technical questions, leave feedback or ask other users for help. %1$sjoin now%2$s', 'kata' ), '<a href="https://www.facebook.com/climaxthemes/" class="kt-dashboard-links">', '<i class="dashicons dashicons-arrow-right-alt2"></i></a>' );
                                ?>
                            </p>
                        </div>
                    </div>
