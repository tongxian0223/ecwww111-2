...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'kata' ),
				'change'       => esc_html__( 'Change image', 'kata' ),
				'default'      => esc_html__( 'Default', 'kata' ),
				'remove'       => esc_html__( 'Remove', 'kata' ),
				'placeholder'  => esc_html__( 'No image selected', 'kata' ),
				'frame_title'  => esc_html__( 'Select image', 'kata' ),
				'frame_button' => esc_html__( 'Choose image', 'kata' ),
			)
		);
	}
