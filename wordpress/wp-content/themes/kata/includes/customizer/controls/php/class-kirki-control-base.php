	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'kata' ),
				'remove'               => esc_html__( 'Remove', 'kata' ),
				'default'              => esc_html__( 'Default', 'kata' ),
				'selectFile'           => esc_html__( 'Select File', 'kata' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'kata' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'kata' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'kata' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'kata' ),
			)
		);
