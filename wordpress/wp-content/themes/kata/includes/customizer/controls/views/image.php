...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'kata' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'kata' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'kata' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'kata' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'kata' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'kata' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'kata' ); ?>',
} );
#>
