...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'kata' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'kata' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'kata' ),
			'200'       => esc_html__( 'Light 200', 'kata' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'kata' ),
			'300'       => esc_html__( 'Book 300', 'kata' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'kata' ),
			'400'       => esc_html__( 'Normal 400', 'kata' ),
			'regular'   => esc_html__( 'Normal 400', 'kata' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'kata' ),
			'500'       => esc_html__( 'Medium 500', 'kata' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'kata' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'kata' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'kata' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'kata' ),
			'700'       => esc_html__( 'Bold 700', 'kata' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'kata' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'kata' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'kata' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'kata' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'kata' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'kata' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'kata' ),
		);
	}
